        ...
        projects: [
            {
                ...
                link: {
                    ...
                    href: 'https://alpha-lucky.github.io/Canvas/'
                },
                linkRep: {
                    title: 'Repository link', 
                    href: 'https://github.com/Alpha-Lucky/Canvas'
                },
                img: canvas,
            ...
            },
            {
                ...
                link: {
                    title: 'Link to the deployed version', 
                    href: 'https://alpha-lucky.github.io/hadidja-sweets/'
                },
                linkRep: {
                    title: 'Repository link', 
                    href: 'https://github.com/Alpha-Lucky/hadidja-sweets'
                },
                img: hadidja,
        ...
        cv: [
            {
                ...
                descr: 'С 2017 года выполнял различные заказы по разработке и сопровождению программного обеспечения под руководством руководстводителя проекта, работал с CRM-системами, базами данных, веб-приложениями, веб-сайтами, мобильными приложениями, программным обеспечением для пожаротушения и системами экстренного оповещения.'
            },
            {
                title: 'Образование',
                about: '20.07.2016 - 26.06.2021',
